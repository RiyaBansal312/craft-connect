...
// import "./App.css";
// import VerificationPage from "./components/VerificationPage.jsx"; // ✅ Add import
...
import ArtisanPortfolioManager from "./components/ArtisanPortfolioManager.jsx";
import AdminDashboard from "./components/AdminDashBoard.jsx";
// import VerificationPage from "./components/VerificationPage.jsx"; // ✅ NEW
import { UserContext } from "./contexts/UserContext.jsx";
import ServiceBookingForm from "./components/ServicesBookingForm.jsx";
  ...
  return (
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/register" element={<Register />} />
        <Route path="/login" element={<Login />} />
        {/* <Route path="/verification" element={<VerificationPage />} /> ✅ NEW */}
